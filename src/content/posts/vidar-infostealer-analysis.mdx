...
emoji: "🦹‍♀️"
url: "vidar-infostealer-analysis"
...
![malware diagram](https://imgur.com/WBDP7Fm.png)
...
![loader decryption routine](https://imgur.com/QvBuO0w.png)

## Second Stage Loader

The second stage loader performs the process injection to load the final stage payload into memory. In this case, it used a _process hollowing but not really_ approach to injecting the VIDAR binary into an `AppLaunch.exe` process.
...
![ntcreateuserprocess arguments](https://imgur.com/PH6VhGC.png)
...
![virtualalloc arguments](https://imgur.com/cf1PTBz.png)

**VirtualAllocEx Arguments**
![virtualallocex arguments](https://imgur.com/tgTZsWP.png)
...
![writeprocessmemory arguments](https://imgur.com/N1ZajNQ.png)
...
![memory map of buffer space](https://imgur.com/O1sipTX.png)
...
![unreadable imports](https://imgur.com/TsDvJsa.png)
...
![realigned section table](https://imgur.com/Q1HmOVK.png)

Now the executable has been correctly aligned, the module and function imports are now readable.

![readable imports](https://imgur.com/s9kUoGD.png)
...
Interestingly, the VIDAR malware leverages legitimate services to host C2 configuration data. For example, the _Telegram_ and _Steam_ profile links contain IP addresses, whereas the `5.75.253[.]16` appears to be consistent with threat actor infrastructure. This way, the malware operators can contiunously cycle C2 servers and have the malware beacon back to each new IP address so long as the social media profiles hosting the C2 IP address remain active.

![steam profile](https://imgur.com/U8sOgzt.png)
![telegram profile](https://imgur.com/X7f4Z8l.png)
...
![ida update.zip](https://imgur.com/guKY354.png)
...
![IDA post](https://imgur.com/unQribv.png)
...
![ida cmd](https://imgur.com/5od7g3V.png)
