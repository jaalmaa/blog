...
_Image courtesy of [Telekom](https://github.security.telekom.com/2023/08/darkgate-loader.html)_
...
Next, the loader injects the final DARKGATE payload into a newly-spawned process instance of `C:\Program Data\Google\Update\GoogleUpdate.exe`.
